...
export declare const Render: (file: string) => (target: any, propertyKey: string, descriptor: PropertyDescriptor) => any;
export declare const RenderFile: (storage?: string | undefined, download?: boolean | undefined) => (target: any, propertyKey: string, descriptor: PropertyDescriptor) => any;
